...
export function StatusCheckModal({ onClose, prefillEmail = "" }: Props) {
  ...
  useEffect(() => {
    if (status === "approved" && result && result !== "not_found") {
      const key = `nexus_reg_feedback_${result.id}`;
      if (!localStorage.getItem(key) && !feedbackDone) {
        setShowFeedback(true);
      }
    }
  }, [status, result, feedbackDone]);
  ...
  return (
    <>
        ...
        >
          ...
          <ScrollArea style={{ flex: 1, minHeight: 0 }}>
            <div className="px-8 py-6 space-y-5">
              ...
              {hasResult && (
                <div
                  data-ocid="status_check.success_state"
                  className="space-y-4"
                >
                  {/* Status badge row */}
                  <div
                    ...
                    <>
                      ...
                      {result.loginUsername && (
                        ...
                        >
                          ...
                          >
                            \u26A0 Keep your credentials secure. Do not share
                            with anyone.
                          </p>
                        </div>
                      )}
                      ...
                      >
                        ...
                        >
                          ...
                          <p>
                            ...
                            registration request has been successfully approved
                            by our Application Administration Team.
                          </p>
                          <p>
                            We extend our sincere appreciation for your patience
                            and for choosing to be part of our Conference
                            Service Management System. Your inclusion
                            strengthens our commitment to maintaining a
                            well-organized, efficient, and professional
                          ...
                          <p>
                            ...
                            workflow experience and contribute positively to
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          ...
                          <p>
                            If you believe your request requires
                            reconsideration, you may contact the Application
                            Administration Team with appropriate details and
                    ...
                    >
                      ...
                      >
                        ...
                        <p>
                          ...
                          request has been successfully received and is
                          currently under review by our Application
                          Administration Team.
                        </p>
                        <p>
                          We value your patience and cooperation during this
                          process. Our team is carefully verifying your details
                          to ensure a secure and well-structured system
                          experience for all users.
                        </p>
                        <p>
                          Kindly allow us some time to complete the
                          verification. You will be notified shortly once your
                          request has been reviewed and processed.
                        </p>
      ...
      {showFeedback && result && result !== "not_found" && (
        <FeedbackModal
          bookingId={result.id}
          roomName="Registration Approval"
          bookerName={result.name}
          email={result.email}
          onComplete={() => {
            localStorage.setItem(`nexus_reg_feedback_${result.id}`, "done");
