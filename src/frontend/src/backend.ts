...
export class Backend implements backendInterface {
    ...
    async getAllRegistrations(): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
    ...
    async getMyRegistrationStatus(): Promise<UserProfile | null> {
        if (this.processError) {
            try {
    ...
    async getPendingRegistrations(): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
    ...
    async registerUser(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async rejectUser(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rejectUser(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        registrationPurpose: value.registrationPurpose,
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? UserStatus.pending : "approved" in value ? UserStatus.approved : "rejected" in value ? UserStatus.rejected : value;
}
...
function to_candid_UserStatus_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserStatus): _UserStatus {
...
function to_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        registrationPurpose: value.registrationPurpose,
        status: to_candid_UserStatus_n14(_uploadFile, _downloadFile, value.status),
        principal: value.principal,
        country: value.country,
        dateOfBirth: value.dateOfBirth,
        name: value.name,
...
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserStatus): {
    pending: null;
} | {
    approved: null;
} | {
